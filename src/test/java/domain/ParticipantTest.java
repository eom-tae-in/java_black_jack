...
public class ParticipantTest {
    ...
    @BeforeEach
    void initData() {
        participant = new Participant(new Name("test"), new ResultDto(0, 0, 0), new ParticipantDeck());
    }
    ...
    void getWinTest() {
        //given
        participant = new Participant(new Name("test"), new ResultDto(1, 0, 0), new ParticipantDeck());
    ...
    void getDrewTest() {
        //given
        participant = new Participant(new Name("test"), new ResultDto(1, 2, 0), new ParticipantDeck());
    ...
    void getLoseTest() {
        //given
        participant = new Participant(new Name("test"), new ResultDto(1, 2, 3), new ParticipantDeck());
